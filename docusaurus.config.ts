    ...
    navbar: {
      ...
      items: [
        ...
        {to: '/examples', label: 'Examples', position: 'left'},
        {
          ...
          position: 'left',
          items: [
            {label: 'Praxis Core', href: 'pathname:///praxis-core-booklet.html'},
            {label: 'Praxis AI', href: 'pathname:///praxis-ai-booklet.html'},
            {label: 'Praxis Grid', href: 'pathname:///praxis-grid-booklet.html'},
          ],
        },
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {label: 'Core Visual Guide', href: 'pathname:///praxis-core-booklet.html'},
            {label: 'AI Visual Guide', href: 'pathname:///praxis-ai-booklet.html'},
            {label: 'Grid Visual Guide', href: 'pathname:///praxis-grid-booklet.html'},
          ],
        },
      ],
