...
[Pipeline Concepts: Filter Results](/docs/architecture/pipeline-concepts#filter-results).
...
[names]: /docs/architecture/pipeline-concepts#the-two-meanings-of-name
...
- [Pipeline Concepts](/docs/architecture/pipeline-concepts):
